...
if(isset($_POST['name']) && isset($_POST['number'])){
    ...
    $mail->Body = '<h1> Name: '.$_POST['name']. '<br/> Email: '. $_POST['email'] . '<br/> Number: ' .$_POST['number']. '<br/> Subject: '. $_POST['subject']. '<br/> Message: '. $_POST['message']. '</h1>'; 
  ...
  try{
    ...
    $mailToCustomer->Subject = "Thank you for your Feedback";
