...
if(isset($_POST['name']) && isset($_POST['number'])){
    ...
    $mail->isHTML(true);
    $mail->Subject = "Mail from Buy page";
    $mail->Body = '<h1> Name: '.$_POST['name']. '<br/> Email: '. $_POST['email'] . '<br/> Number: ' .$_POST['number']. '<br/> BusinessType: '. $_POST['type']. '<br/> Pincode: '. $_POST['pincode']. '<br/> Address: '. $_POST['address']. '</h1>'; 
